...
STEP 4 (CHECK IF CONTAINERS AND NETWROK IS WORKING):
`docker ps`
`docker network ls`
...
`mongodb://admin:12345@localhost:27019/?authSource=admin&replicaSet=rs0&directConnection=true (provejri connection)`

STEP 13 (CHECK LOGGING)
http://localhost:5601/app/discover#/ (Kibana logging) 
...
http://localhost:8090 (Provjecri backedn)
